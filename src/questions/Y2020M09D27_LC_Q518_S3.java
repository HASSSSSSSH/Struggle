 ...
 * <p>
 * Different implementation of {@link Y2020M09D27_LC_Q518_S2}
 */
public class Y2020M09D27_LC_Q518_S3 {

    public static void main(String args[]) {
        Y2020M09D27_LC_Q518_S3 instance = new Y2020M09D27_LC_Q518_S3();
        // (0, new int[]{})
        // (0, new int[]{1, 2})
        // (5, new int[]{1, 2, 5})
    ...
    public int change(int amount, int[] coins) {
        ...
        for (int i = 1; i < length; i++) {
            ...
            for (int value = 0; value <= amount; value++) {
                ...
                // 依次选取 0, 1, ..., k 枚硬币 coin[i]
                while (k * coins[i] <= value) {
                    sum += dp[i - 1][value - (k * coins[i])];
                    k++;
                }
