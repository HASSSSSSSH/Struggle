 ...
 * <p>
 * Different implementation of {@link Y2020M11D20_LC_Q72_S1}: More Readable
 */
public class Y2020M11D24_LC_Q72_S4 {

    public static void main(String args[]) {
        Y2020M11D24_LC_Q72_S4 instance = new Y2020M11D24_LC_Q72_S4();
     ...
     * <p>
     * 于是定义函数 minDistance(i, j, word1, word2)
     * 返回 word1[0..i] 和 word2[0..j] 的最小编辑距离 (将 word1[0..i] 转换成 word2[0..j] 所使用的最少操作数)
     * <p>
     ...
     * 综上所述, 可得出结论:
     * <p>
     * 当 word1[i] == word2[j] 时, word1[0..i] 和 word2[0..j] 的最小编辑距离 = minDistance(i - 1, j - 1, word1, word2)
     * <p>
     * 当 word1[i] != word2[j] 时, word1[0..i] 和 word2[0..j] 的最小编辑距离
    ...
    public int minDistance(int index1, int index2, String word1, String word2) {
        ...
        if (index1 >= 0 && word1.charAt(index1) == word2.charAt(index2)) {
            return minDistance(index1 - 1, index2 - 1, word1, word2);
        } else {
