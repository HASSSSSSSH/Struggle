 ...
 * <p>
 * Optimization of {@link Y2020M11D17_LC_Q416_S4}
 */
public class Y2020M11D17_LC_Q416_S5 {

    public static void main(String args[]) {
        Y2020M11D17_LC_Q416_S5 instance = new Y2020M11D17_LC_Q416_S5();
    ...
    /**
     * 增加剪枝逻辑
     * 由于状态方程的特殊性, 只要满足条件: 候选数组在前缀子区间 [0, i] 能够 恰好 凑成数值 half, 遍历就可以提前结束
     */
    public boolean canPartition(int[] nums) {
        ...
        for (int num : nums) {
            ...
            for (int j = half; j >= num; j--) {
                ...
                // 位运算符 '|' 即可
                // 此时状态方程应当是: dp[i][j] = dp[i - 1][j] | dp[i - 1][j - nums[i]] (j >= nums[i])
                // dp[j] = dp[j] || dp[j - num];
            }
